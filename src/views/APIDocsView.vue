<template>
    <section class="px-4 py-12">
        <div class="max-w-md mx-auto md:max-w-[46rem] xl:max-w-[65.75rem]">
            <h3 class="text-4xl font-bold -mt-1.75">GET/v1/users</h3>
            <p class="mt-1 mb-4.5">Retrieves a list of all users associated with your project.</p>
            <h4 class="text-xl font-bold mb-2.25">Example Request</h4>
            ...
            <h4 class="text-xl font-bold mb-2.25">Example Response (200 OK)</h4>
